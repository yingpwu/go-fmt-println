...
export function activate(context: vscode.ExtensionContext) {
    ...
    vscode.commands.registerCommand("gofmt.displayLogMessage", async () => {
        ...
        const config: vscode.WorkspaceConfiguration =
            vscode.workspace.getConfiguration("gofmt");
    ...
    vscode.commands.registerCommand("gofmt.commentAllLogMessages", () => {
        const editor: vscode.TextEditor | undefined =
            vscode.window.activeTextEditor;
        if (!editor) {
            return;
    ...
    vscode.commands.registerCommand("gofmt.uncommentAllLogMessages", () => {
        const editor: vscode.TextEditor | undefined =
            vscode.window.activeTextEditor;
        if (!editor) {
            return;
    ...
    vscode.commands.registerCommand("gofmt.deleteAllLogMessages", () => {
        const editor: vscode.TextEditor | undefined =
            vscode.window.activeTextEditor;
        if (!editor) {
            return;
...
function getExtensionProperties(
    ...
    const delimiterInsideMessage =
        workspaceConfig.delimiterInsideMessage || "~";
